...
from revelio.vulnerabilities import Bias, Toxicity
from revelio.attacks.single_turn import PromptInjection
...
```python
from revelio.attacks.single_turn import Roleplay
