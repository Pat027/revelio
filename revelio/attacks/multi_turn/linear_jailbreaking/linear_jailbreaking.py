...
from revelio.attacks.multi_turn.linear_jailbreaking.schema import (
    Improvement,
    Feedback,
)
from revelio.attacks.multi_turn.linear_jailbreaking.template import (
    JailBreakingTemplate,
)
from revelio.attacks.attack_simulator.utils import (
    generate,
    a_generate,
)
from revelio.attacks.multi_turn.types import CallbackType
from revelio.utils import create_progress, update_pbar, add_pbar
from revelio.attacks.single_turn import BaseSingleTurnAttack
from revelio.attacks.base_attack import Exploitability
from revelio.attacks.multi_turn.base_multi_turn_attack import (
    BaseMultiTurnAttack,
)
from revelio.attacks.multi_turn.utils import enhance_attack, a_enhance_attack
from revelio.attacks.multi_turn.base_schema import NonRefusal
from revelio.attacks.multi_turn.base_template import BaseMultiTurnTemplate
from revelio.errors import ModelRefusalError
from revelio.test_case.test_case import RTTurn
from revelio.vulnerabilities.types import VulnerabilityType
...
class LinearJailbreaking(BaseMultiTurnAttack):
    ...
    def progress(
        ...
        from revelio.red_teamer.utils import (
