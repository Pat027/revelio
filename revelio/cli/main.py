...
from revelio.red_teamer.risk_assessment import RiskAssessment

app = typer.Typer(name="revelio")
...
def _show_version(value: bool):
    ...
    if value:
        typer.echo(f"revelio version {__version__}")
        raise typer.Exit()
...
def main(
    ...
    """
    Revelio CLI for red teaming LLMs.
    """
    pass
