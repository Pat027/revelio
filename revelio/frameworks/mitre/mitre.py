...
from revelio.frameworks.mitre.risk_categories import MITRE_CATEGORIES
...
Revelio's MITRE ATLAS module implements these adversarial mappings to test AI and LLM applications 
