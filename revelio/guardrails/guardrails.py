...
from revelio.guardrails.guards.base_guard import BaseGuard
from revelio.telemetry import capture_guardrail_run
...
class Guardrails:
    ...
    def _update_guards_model(
        ...
        """Update all guards to use the specified evaluation model"""
        from revelio.guardrails.guards.base_guard import initialize_model
