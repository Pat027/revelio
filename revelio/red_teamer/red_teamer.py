...
from revelio.confident.api import Api, Endpoints
from revelio.red_teamer.api import map_risk_assessment_to_api
...
from revelio.telemetry import capture_red_teamer_run
...
from revelio.red_teamer.utils import resolve_model_callback
from revelio.vulnerabilities import BaseVulnerability
from revelio.vulnerabilities.types import VulnerabilityType
from revelio.attacks.attack_simulator import AttackSimulator
...
class RedTeamer:
    ...
    def _print_risk_assessment(self, risk_assessment=None):
        ...
        console.print("\n" + "=" * 80)
        console.print(
            f"[bold magenta]🔍 Revelio Risk Assessment[/bold magenta] ({risk_assessment.overview.errored} errored)"
        )
        console.print("=" * 80)
    ...
    def _post_risk_assessment(self):
        if not is_confident():
            ...
            console.print(
                ...
                "  » Run [bold]'revelio login'[/bold] to analyze and save testing results on [rgb(106,0,255)]Confident AI[/rgb(106,0,255)].\n\n",
            )
            return
